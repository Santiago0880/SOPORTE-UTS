<?php if(isset($_SESSION['nombre']) && isset($_SESSION['tipo'])){
        ...
        if(isset($_POST['fecha_ticket']) && isset($_POST['name_ticket']) && isset($_POST['email_ticket'])){
          ...
          $cabecera="From: Soporte UTS<soporteuts@correo.edu.co>";
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <select class="form-control" name="departamento_ticket">
                                  <option value="Ventas">Rectoria</option>
                                  <option value="Software">Vicepresidencia</option>
                                  <option value="Hardware">Fondo Emprender</option>
                                  <option value="Hardware">Financiera</option>
                                  <option value="Hardware">Prensa</option>
                                  <option value="Hardware">OACA</option>
                                  <option value="Hardware">ODA</option>
                                  <option value="Hardware">CORD. Ambiental</option>
                                  <option value="Hardware">CORD. Petroleos</option>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7 text-center">
                <h1 class="text-danger">Lo sentimos esta página es solamente para usuarios registrados en Soporte UTS</h1>
